...
std::vector<Vector3> SpawnManager::LoadFile(const std::string fileName)
{
    ...
    ////nlohmann::json EnemyGroup group;
    ////group.spawnDelay = j["EnemyGroup1"]["spawnDelay"].get<float>();

    //std::vector<Vector3> goalOffsets;
